...
\ri{Numerical Methods} for approximate solutions to partial differential equations.\\
\ri{Multiscale Analysis and Computation} to model complex systems, e.g. rivers.
