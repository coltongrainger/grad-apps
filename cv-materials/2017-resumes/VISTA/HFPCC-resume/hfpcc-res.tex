...
\section{SUMMARY OF QUALIFICATIONS} \vspace{7.8pt}
	\begin{details}
		...
		\flit{2 years' expertise in data management.}{hltm}
...
\section{PROFESSIONAL EXPERIENCE}
	\job{Clerk | Refugee Case Management}{September 2016 -- July 2017}{YMCA International Services, Houston, TX}{ltmsefnh}
		\begin{details}
			\flit{Managed 240 cases (60 medical, 180 social adjustment) on a team of 8 staff.}{tm}
			\flit{Supported 7 staff over 240 client cases (60 medical, 180 social adjustment).}{nlsh}
			\flit{Obtained low-income healthcare for 30 cases and rental assistance for 5 cases.}{smnh}
			\flit{Scheduled medical appointments with transportation and interpretation.}{nltmh}
 ...
 %HEALTHCARE Anasthesia, Samson, Raziah, Mhd Sultan, Shabukon, Yaneisy, Maryam, Al Attabi, cuban walk in, Fatimah, Thamer, Omid, Rimsha, Nasira, Marzieh, cuban walk in, cuban walk in, Ammar, Habal, Azi, Khaibar, Mhd Amin, Musaningare, Nada RENTAL: Raziah, Khaibar, Reza, Mhd Rafique, Awut, Jesus 
		...
		\end{details}
	\job{Grading Assistant}{September 2015 -- December 2015}{The College of Idaho}{ltmsnh}
		\begin{details}
			\flit{Corrected weekly assignments for 25 general physics students.}{ltmsnh}
			\flit{Corresponded with faculty to ensure objective and accurate grading.}{ltmsnh}%did I have any copying cases?
		\end{details} 
	...
	% 	\end{details} 
	\job{Dishwasher \& Server}{Summers 2012, 2013, Fall 2015}{The Griddle, Meridian, ID}{ltmsh}
		\begin{details}
			\flit{Kept clean a 600 $\mathrm{ft}^2$ commercial kitchen.}{ltmh}
			\flit{Trained new staff for the front of house and kitchen.}{ltmsh}
...
\section{COMMUNITY INVOLVEMENT}
	\job{Service Corps Fellow}{August 2016 -- July 2017}{Texas Episcopal Service Corps, Houston, TX}{ltmsefnh}
		\begin{details}
			\flit{Completed a year of service (1,800 hours) while living in community.}{ltmsefnh}
			\flit{Received training in non-violent communication.}{ltmef}
			\flit{Participated in professional development and communication training.}{nh}
...
%		\end{details}
	...
	\job{Dean | Gem Boys State}{June 2014 and 2015}{Northwest Nazerene University, Nampa, ID}{h}
		\begin{details}
...
\section{JOB RELATED COMPETENCIES (rated out of 5)} \vspace{0pt}
	\begin{multicols}{2}
		...
		\begin{skill}{Communication}
			...
			\item Grant writing (3) %gayls legacy fund
			\item Event planning (3) %boys state and refugee health working group
		\end{skill}
	\end{multicols}
