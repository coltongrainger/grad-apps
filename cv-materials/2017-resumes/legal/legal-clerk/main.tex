...
\newcommand{\jobtitle}{a Receptionist/Clerk}
\newcommand{\company}{a law firm in Olympia, WA}
...
\section{EDUCATION}
	\degree{B.S. in Mathematics-Physics}{May 2016}{The College of Idaho, Caldwell, ID%\hfill {\rm GPA: 3.49}}
		...
		\begin{details}
			...
			\flit{Minors: History, English Literature and German Language.}{ltm}
...
\section{PROFESSIONAL EXPERIENCE}
	\job{Clerk | Refugee Medical Care}{September 2016 -- July 2017}{YMCA International Services, Houston, TX}{ltmsef}
		\begin{details}
			...
			\flit{Supported 7 staff over 240 client cases (60 health, 180 social adjustment).}{l}
			...
			\flit{Performed outreach and networking with safety-net services.}{s}
	...
	\job{Grading Assistant}{September 2015 -- December 2015}{The College of Idaho}{ltms}
		\begin{details}
			\flit{Corrected weekly assignments for 25 general physics students.}{ltm}
			\flit{Corresponded with faculty to ensure objective and accurate grading.}{ltm}%did I have any copying cases?
		\end{details} 
	...
	\job{Dishwasher \& Server}{Summers 2012, 2013, Fall 2015}{The Griddle, Meridian, ID}{ltms}
		\begin{details}
			...
			\flit{Trained new staff for the front of house and kitchen.}{ltm}
...
\section{COMMUNITY INVOLVEMENT}
	\job{Service Corps Fellow}{August 2016 -- July 2017}{Texas Episcopal Service Corps, Houston, TX}{ltmsef}
		\begin{details}
			...
			\flit{Received training in non-violent communication.}{ltmsef}
...
%		\end{details}
	\job{Gem Boys State Counselor}{June 2012, 2013, 2014, 2015}{Northwest Nazerene University, Nampa, ID}{mts}
		\begin{details}
...
\section{AWARDS} \vspace{10pt}
	\begin{description}[noitemsep,topsep=0pt]
		...
		\award{Heritage Scholarship}{for academic merit. \hfill 2012 -- 2016}{ltms}
	\end{description}
