...
\objective{To gain employment as \jobtitle\ at \company.}{ns}

\section{SUMMARY OF QUALIFICATIONS} \vspace{7.8pt}
	\begin{details}
		\flit{Administrative experience from 1 year of service in refugee medical care.}{n}
		\flit{1 year of service in refugee medical care and case management.}{hs}
		...
		\flit{Enthusiasm for wholistic social services, outreach and volunteerism.}{s}
...
\section{PROFESSIONAL EXPERIENCE}
	\job{Clerk | Refugee Medical Care \& Case Management}{September 2016 -- July 2017}{YMCA International Services, Houston, TX}{ltmsefnhg}
		\begin{details}
			...
			\flit{Created a resource network of safety-net service providers.}{nh}
 %HEALTHCARE Anasthesia, Samson, Raziah, Mhd Sultan, Shabukon, Yaneisy, Maryam, Al Attabi, cuban walk in, Fatimah, Thamer, Omid, Rimsha, Nasira, Marzieh, cuban walk in, cuban walk in, Ammar, Habal, Azi, Khaibar, Mhd Amin, Musaningare, Nada RENTAL: Raziah, Khaibar, Reza, Mhd Rafique, Awut, Jesus 
	...
	\job{Grading Assistant}{September 2015 -- December 2015}{The College of Idaho}{ltmshg}
		\begin{details}
			...
			\flit{Corresponded with faculty to ensure objective and accurate grading.}{ltmhg}%did I have any copying cases?
		\end{details} 
	...
	\job{Dishwasher \& Server}{Summers 2012, 2013, Fall 2015}{The Griddle, Meridian, ID}{ltgshn}
		\begin{details}
			\flit{Kept clean a 600 $\mathrm{ft}^2$ commercial kitchen.}{ltshgn}
...
\section{COMMUNITY INVOLVEMENT}
	\job{Service Corps Fellow}{August 2016 -- July 2017}{Texas Episcopal Service Corps, Houston, TX}{ltmsefnhg}
		...
		\end{details}
	\job{WWOOF Ranch-Hand}{June 2016 -- August 2016}{Sonnwendhof Biofarm, M\"{o}ckm\"{u}hl, Deutschland}{efn}
		\begin{details}
